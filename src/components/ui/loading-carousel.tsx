...
const defaultTips: Tip[] = [
  {
    text: "Path-Pilot is a web tool that helps users map out their career or learning journey with clear pathways and guidance.",
    image: "/project1.png",
    url: "path-pilot-ldp3.vercel.app",
  },
  {
    text: "Hire-Stack is a web app that simplifies hiring by connecting employers with job seekers efficiently.",
    image: "/project2.png",
    url: "https://www.newcult.co/templates/cult-seo",
  },
  {
    text: "SkyCast is a weather app that provides accurate, real-time, and localized forecasts with an intuitive and user-friendly interface for daily planning.",
    image: "/project3.png",
